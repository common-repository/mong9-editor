...
function editor_view_reset() {
//console.log('editor_view_reset 리세팅');
//		jQuery('._setting_area_box,.handle_width').css('display','none');	
//		jQuery('._setting_area_box').css('display','none');	
}